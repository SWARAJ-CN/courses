...
const Footer = () => {
  ...
  const locations = [
    "Calicut", "Kottakkal", "Kochi", "Thrissur", 
    "Perinthalmanna", "Trivandrum", "Chennai", "Dubai", "Bangalore"
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-6">
            ...
            <div className="space-y-4 text-sm leading-relaxed text-slate-400">
              <p>
                NULLBYTE Hackers Academy’s career-focused, implementation-based learning programs 
                pave the road to a success-assured career in Ethical Hacking & Cybersecurity. Our expert 
                instructors provide hands-on training in real-world scenarios, ensuring students are well-prepared 
                to tackle dynamic digital threats.
              </p>
              <p>
                Join us to become a part of a growing community of professionals dedicated to making the digital 
                world a safer place. Start your journey with NULLBYTE and secure your future in the best{" "}
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-center gap-3.5 group cursor-pointer">
                ...
                <span className="group-hover:text-white transition-colors">+91 7907715669</span>
              </div>
              ...
              <div className="flex items-center gap-3.5 group cursor-pointer">
                ...
                <span className="group-hover:text-white transition-colors">+91 799 656 473</span>
              </div>
            </div>
          </div>
        </div>
