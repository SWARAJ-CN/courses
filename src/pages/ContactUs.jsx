...
const ContactUs = () => {
  ...
  return (
    <div className="bg-slate-50 font-sans min-h-screen text-slate-900">
      <div className="bg-linear-to-r from-blue-700 to-blue-900 text-white py-20 px-6 text-center">
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 -mt-10">
        <div className="lg:col-span-5 space-y-6 lg:pt-10">
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-bold text-slate-900 text-lg mb-1">Our Headquarters</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm font-medium hover:text-blue-600 transition-colors">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-bold text-slate-900 text-lg mb-1">Email Correspondence</h3>
              <p className="text-slate-600 text-sm font-medium hover:text-blue-600 transition-colors">
        ...
        <div className="lg:col-span-7 bg-white p-8 md:p-10 rounded-2xl border border-slate-100 shadow-md relative">
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600 focus:bg-white transition-colors"
                />
              </div>
              <div>
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2">Subject / Field of Interest</label>
              <input 
                type="text" 
                name="subject"
                required
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-2">Your Transmission (Message)</label>
              <textarea 
                rows="5"
                name="message"
                required
                placeholder="Type your detailed message here..." 
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-600 focus:bg-white transition-colors resize-none"
              ></textarea>
            </div>

            <button 
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm py-4 rounded-xl shadow-lg shadow-blue-200 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Send Message
            </button>
          </div>
