  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white max-w-2xl leading-tight">
           Launch Your Hacking Journey: <br className="hidden sm:inline" />{" "}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-items-center sm:justify-items-start">
       ...
       <p className='mt-14'>Explore our <span className='text-blue-500'>course on cyber security in india </span>and learn ethical hacking and practical cybersecurity skills with hands-on training.</p>
    </div>
